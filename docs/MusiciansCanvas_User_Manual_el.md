...
- Μίξη σε WAV, FLAC, MP3, Ogg Vorbis ή AIFF (προαιρετικό bitrate/ποιότητα για MP3 και Ogg στο **Mix tracks to file**)
...
- **Μορφή**: Ορίστε την επέκταση κατά την αποθήκευση — **FLAC** (συμπίεση χωρίς απώλειες), **WAV** (ασυμπίεστο PCM), **MP3**, **Ogg Vorbis** ή **AIFF**. Οι μορφές με απώλειες (MP3, Ogg) δίνουν μικρότερα αρχεία· τα WAV, FLAC και AIFF μπορεί να είναι χωρίς απώλειες ανάλογα με την πηγή.
- **Encoding** (μόνο MP3 και Ogg Vorbis): Αν το όνομα αρχείου προορισμού τελειώνει σε `.mp3`, `.ogg` ή `.oga`, εμφανίζεται η ενότητα **Encoding**. Για **MP3** επιλέξτε CBR, ABR ή VBR και ορίστε bitrate ή ποιότητα VBR. Για **Ogg Vorbis** επιλέξτε μεταβλητό bitrate βάσει ποιότητας ή κατά προσέγγιση ονομαστικό bitrate. Για **WAV**, **FLAC** και **AIFF** αυτή η ενότητα δεν εμφανίζεται.
