...
source = os.path.join(script_dir, 'MusiciansCanvas_User_Manual.md')
output = os.path.join(html_dir, 'MusiciansCanvas_User_Manual.html')
...
<title>Musician's Canvas User Manual</title>
<style>{css}</style>
</head>
<body>
<div class="title-block">
<h1>Musician&#8217;s Canvas User Manual</h1>
<p>Multi-Track Music Recording Application &mdash; Version {version}</p>
<p>{date}</p>
</div>
<div class="toc">
