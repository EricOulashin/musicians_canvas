...
![メインウィンドウ](../screenshots/MusiciansCanvas_1_MainWin.png)

### ボタンバー

メニューバーのすぐ下に、クイックアクセスボタンを備えたツールバーがあります：

![ボタンバー](../screenshots/ButtonBar.png)
...
![トラック設定](../screenshots/MusiciansCanvas_2_TrackConfig.png)
...
![トラックエフェクト](../screenshots/Track_Effects_Dialog.png)

**リバーブ**、**コーラス**、**フランジャー**、**オーバードライブ／ディストーション**、**アンプ＆キャビネット**（アンプ種別、キャビネット、ゲイン、低／中／高域、エアー、ミックスなどのモデリング）を追加できます。**アンプ＆キャビネット** の画面例：

![アンプ＆キャビネット・モデリング (1)](../screenshots/Amp_And_Cabinet_Model_1.png)

![アンプ＆キャビネット・モデリング (2)](../screenshots/Amp_And_Cabinet_Model_2.png)
...
![メトロノーム設定](../screenshots/MetronomeSettings.png)
...
![ディスプレイ設定](../screenshots/MusiciansCanvas_DisplaySettings.png)
...
![言語設定](../screenshots/MusiciansCanvas_LanguageSettings.png)
...
![MIDI設定](../screenshots/MusiciansCanvas_4_MIDISettings.png)
...
![オーディオ設定](../screenshots/MusiciansCanvas_5_AudioSettings.png)
...
![プロジェクトMIDI設定](../screenshots/MusiciansCanvas_6_ProjectMIDISettings.png)
...
![プロジェクトオーディオ設定](../screenshots/MusiciansCanvas_7_ProjectAudioSettings.png)
...
| メニュー項目                         | ショートカット | 説明                                    |
|-------------------------------------|----------|------------------------------------------|
| Project Settings                    | Ctrl+P   | プロジェクト固有の設定を構成              |
...
![Virtual MIDI Keyboard設定](../screenshots/VMIDIKeyboard2.png)
